...
tbegin = datetime(2008, 4, 27, 6, 28, 1)
tend = datetime(2008, 5, 27, 6, 28, 1)
...
#    dist = sqrt(x**2.0 + y**2.0)
    ...
    plt.xlabel('Time (hours) since 2008/04/27', fontsize=24)
...
#        fontsize=24)
    plt.savefig('zoom_teq5/' + templates[i][0].astype(str) + '.eps', format='eps')
    plt.close(1)
