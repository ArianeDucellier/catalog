...
\title{A twelve-year-long low-frequency earthquake catalog for Northern California}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth, trim={0cm 0cm 0cm 0cm},clip]{figures/tremor_nb.eps}
...
First comparison with 2007-2009 catalog with FAME data

\section{Results}

Now extension of the catalog, we will try 1995-2011.

New templates? New catalog? probably no time (or money)

\section{Discussion}

Section on effects of nearby earthquakes. Possible rapid tremor reversals
