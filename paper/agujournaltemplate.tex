...
\caption{Normalize cumulative number of LFEs over the period July 2007-July 2009 for the FAME catalog (red) and the network catalog (blue) for family B (inverted triangle in Figure 1).}
\label{pngfiguresample}
\end{figure}

\begin{figure}
\noindent\includegraphics[width=\textwidth, trim={0cm 0cm 0cm 0cm},clip]{figures/080401_05_050.eps}
\caption{Normalize cumulative number of LFEs over the period July 2007-July 2009 for the FAME catalog (red) and the network catalog (blue) for family A (square in Figure 1).}
\label{pngfiguresample}
\end{figure}
